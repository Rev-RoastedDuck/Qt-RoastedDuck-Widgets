...
class SwitchButtonCommon(QToolButton):
...
class SwitchButton(SwitchButtonCommon):
    def setParams(self,
...
class SwitchButton_2(SwitchButtonCommon):
    def setParams(self,
    ...
    def paintBackground(self, painter: QPainter):
        ...
        if self.isChecked():
            painter.setPen(self.checked_background_color)
        else:
...
class SwitchButton_3(SwitchButtonCommon):
    def setParams(self,
                  indicator_color: QColor = QColor(255, 255, 255),
...
class SwitchButton_4(SwitchButtonCommon):
    def animaParamsInit(self):
...
class SwitchButton_5(SwitchButtonCommon):
    def setParams(self,
                  indicator_color: QColor = QColor(255, 255, 255),
                  background_color: QColor = QColor(204, 204, 204),
                  checked_background_color: QColor = QColor(153, 0, 51, 200),
...
class Window(QWidget):
    def __init__(self, parent=None):
        ...
        self.switchButton_1 = SwitchButton(parent=self)
        self.switchButton_1.setGeometry(400, 200, 80, 40)
        self.switchButton_1.setParams(checked_background_color=QColor(0, 89, 89))

        self.switchButton_2 = SwitchButton_2(parent=self)
        self.switchButton_2.setGeometry(500, 200, 80, 40)
        ...
        self.switchButton_3.setGeometry(385, 250, 100, 50)
        self.switchButton_3.setParams(checked_background_color=QColor(0, 89, 89, 200),
                                      checked_indicator_color=QColor(255, 255, 255))

        self.switchButton_4 = SwitchButton_4(parent=self)
        self.switchButton_4.setGeometry(480, 250, 100, 50)
        self.switchButton_4.setParams(checked_background_color=QColor(0, 89, 89, 200),
                                      checked_indicator_color=QColor(255, 255, 255))

        self.switchButton_5 = SwitchButton_5(parent=self)
        self.switchButton_5.setGeometry(400, 310, 70, 35)
