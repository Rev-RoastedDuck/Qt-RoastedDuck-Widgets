...
class ExpInput(QWidget):
    def __init__(self, parent=None):
        super(ExpInput, self).__init__(parent)
        self.componentInit()
        self.is_focus = False
    ...
    def setStyleSheet(self, styleSheet):
        super(ExpInput, self).setStyleSheet(styleSheet)
    ...
    def mousePressEvent(self, event):
        super(ExpInput, self).mousePressEvent(event)
    ...
    def leaveEvent(self,event):
        super(ExpInput, self).leaveEvent(event)
    ...
    def setGeometry(self, g):
        super(ExpInput, self).setGeometry(g)
