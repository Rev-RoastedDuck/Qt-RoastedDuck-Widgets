...
if __name__ == '__main__':
    ...
    win = FlexibleSidebar(w)
    win.setParams(53,141,background_color=QColor(0,89,89,200),border_radius=15)
    win.setGeometry(100, 40, 141, 271)

    btn_1 = FlexibleSidebarButton(text="Close", icon=icon1, parent=win)
    btn_2 = FlexibleSidebarButton(text="Enter", icon=icon2, parent=win)
    btn_3 = FlexibleSidebarButton(text="SetKey", icon=icon3, parent=win)
    btn_4 = FlexibleSidebarButton(text="Resign", icon=icon4, parent=win)
    btn_5 = FlexibleSidebarButton(text="Verify", icon=icon5, parent=win)
    btn_6 = FlexibleSidebarButton(text="Share", icon=icon6, parent=win)
