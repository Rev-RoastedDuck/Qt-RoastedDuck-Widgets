...
class RInput(QWidget):
    def __init__(self, parent=None):
        super(RInput, self).__init__(parent)
        self.componentInit()
        self.is_focus = False
    ...
    def setStyleSheet(self, styleSheet):
        super(RInput, self).setStyleSheet(styleSheet)
    ...
    def mousePressEvent(self, event):
        super(RInput, self).mousePressEvent(event)
    ...
    def leaveEvent(self,event):
        super(RInput, self).leaveEvent(event)
    ...
    def setGeometry(self, g):
        super(RInput, self).setGeometry(g)
