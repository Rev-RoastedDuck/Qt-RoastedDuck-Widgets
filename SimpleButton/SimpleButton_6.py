...
class SimpleButton_6(QPushButton):
    ...
    def animationConfig(self):
        self.anima_width = 0
        self.anima_width_var = 10
        self.anima_max_width = self.width()
    ...
    def incWidth(self):
        self.anima_width += self.anima_width_var
        if self.anima_width > self.anima_max_width:
            self.anima_width = self.anima_max_width
            self.timer.stop()
        self.update()

    def decWidth(self):
        self.anima_width -= self.anima_width_var
        if self.anima_width < 0:
            self.anima_width = 0
            self.timer.stop()
        self.update()
