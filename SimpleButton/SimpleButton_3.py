...
class SimpleButton_3(QPushButton):
    def __init__(self,parent=None):
        super(SimpleButton_3, self).__init__(parent)
        self.text = ""
    ...
    def getStyleSheetParams(self):
        """ 提取样式 """
        SimpleButton_3_property: dict = get_property(self)["SimpleButton_3"]
        self.border_radius = transfer_type(SimpleButton_3_property["border-radius"], "pixel")
        self.font_color_origin = transfer_type(SimpleButton_3_property["color"], "color")
    ...
    def paintEvent(self, event):
        super(SimpleButton_3, self).paintEvent(event)
    ...
    def showEvent(self, event) -> None:
        super(SimpleButton_3, self).showEvent(event)
        self.animationConfig()

    def setStyleSheet(self, styleSheet: str) -> None:
        super(SimpleButton_3, self).setStyleSheet(styleSheet)
